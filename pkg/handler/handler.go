...
func (h *Handler) InitRoutes() *gin.Engine {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:3000", "https://rd-cabinet-7mds4.ondigitalocean.app", "rd-cabinet-7mds4.ondigitalocean.app", "https://rd-cabinet-7mds4.ondigitalocean.app/"},
